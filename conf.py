...
# Dave build configuration file, created by
# `ablog start` on Tue Feb  9 15:17:17 2016.
#
...
blog_title = u'Some descriptions of some of my projects'

# Base URL for the website, required for generating feeds.
# e.g. blog_baseurl = "http://example.com/"
blog_baseurl = u'http://swissdrumassault.github.io/'
...
blog_authors = {
    'Biscuit': ('Biscuit Speculator', None),
}
...
project = u'Blog'
copyright = u'2016, Biscuit Speculator'
author = u'Biscuit Speculator'
